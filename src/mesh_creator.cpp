...
{
    sub_ = this->create_subscription<ar_visualisation_msgs::msg::PlanesData>(
        "/s_graphs/all_map_planes", 10, 
        std::bind(&MeshCreator::wallDataCallback, this, std::placeholders::_1)
    );
}

void MeshCreator::wallDataCallback(const ar_visualisation_msgs::msg::PlanesData::SharedPtr msg)
{
    std::vector<ar_visualisation_msgs::msg::PlaneData> planes;
